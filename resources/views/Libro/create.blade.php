                            ...
                            <form method="POST" action="{{ route('libro.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text"
                                                   name="npagina" id="npagina" class="form-control input-sm" placeholder="Número de Páginas">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
<textarea name="resumen" class="formcontrol
input-sm" placeholder="Resumen"></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
...
input-sm" placeholder="Autor"></textarea>
                                </div>
                                <div class="row">
